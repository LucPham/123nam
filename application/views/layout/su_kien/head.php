...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/css/evtStyle.css') ?>">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/css/responsive_evt.css') ?>">
<!--[if IE]>
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/css/ie-evt-style.css') ?>">
