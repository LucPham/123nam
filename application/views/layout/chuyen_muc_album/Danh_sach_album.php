						...
						<?php  
							...
							<tr>
								<td>
						 				...
						 				<a class="tieu_de_tin_moi_nhat" href="<?php echo site_url('album/'.$item['url'].'/'.$item['id']) ?>" title="<?php echo $item['tieu_de'] ?>" alt="<?php echo $item['tieu_de'] ?>">
						 					<img class="img_chuyen_muc_tin" src="<?php echo base_url('public/album/hinh_tieu_de/'.$item['hinh']) ?>" alt="<?php echo $item['tieu_de'] ?>" title="<?php echo $item['tieu_de'] ?>" alt="<?php echo $item['tieu_de'] ?>">
						 				</a>
								</td>	
								...
								<td>
									<p class="td_chuyen_muc_tin">
						 				...
						 				<a class="tieu_de_tin_moi_nhat" href="<?php echo site_url('album/'.$item['url'].'/'.$item['id']) ?>" title="<?php echo $item['tieu_de'] ?>" alt="<?php echo $item['tieu_de'] ?>"><?php echo $item['tieu_de'] ?></a>
