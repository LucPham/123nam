...
<!--[if IE]>
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/css/ie-index-style.css') ?>">
<![endif]-->
<!--[if IE]>
<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/css/ie-resetpassword-style.css') ?>">
<![endif]-->
