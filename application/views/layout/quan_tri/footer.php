...
<script type="text/javascript" src="<?php echo base_url('public/js/xuat_ban.js') ?>"></script>
<script type="text/javascript" src="<?php echo base_url('public/js/jquery.form.js') ?>"></script>
<script type="text/javascript" src="<?php echo base_url('public/js/tao_su_kien.js') ?>"></script>
	...
	<div class="popup-inner">
		<div class="delete-feedback">
	        ...
	        <div class="col-md-4 col-sm-4 col-xs-6">
	       		 <a href="#" data-popup-close="popup-1" id="huy"><button class="btn btn-sm btn-primary">Hủy</button></a>
	       	</div>
	       	<div class="col-md-4 col-sm-4 hidden-xs"></div>
	       	<div class="col-md-4 col-sm-4 col-xs-6">
	        	<a href="#" data-popup-yes="#" id="co"><button class="btn btn-sm btn-danger">Có</button></a>
			</div>
       </div>
...
<div class="popup" data-popup="popup-2">
	<div class="popup-inner">
		<div class="delete-feedback">
	        ...
	        <div class="col-md-4 col-sm-4 col-xs-6"><a href="#" data-popup-event-close="popup-2" id="cancel"><button class="btn btn-sm btn-primary">Hủy</button></a></div>
	        <div class="col-md-4 col-sm-4 hidden-xs"></div>
	        <div class="col-md-4 col-sm-4 col-xs-6 yes"><a href="#" data-popup-event-yes="#" id="yes"><button class="btn btn-sm btn-danger">Có</button></a></div>
       </div>
...
<div class="popup" data-popup="popup-3">
	<div class="popup-inner">
		<div class="delete-feedback">
	        ...
	        <div class="col-md-4 col-sm-4 col-xs-6"><a href="#" data-popup-album-close="popup-3" id="cancel2"><button class="btn btn-sm btn-primary">Hủy</button></a></div>
	        <div class="col-md-4 col-sm-4 hidden-xs"></div>
	        <div class="col-md-4 col-sm-4 col-xs-6"><a href="#" data-popup-album-yes="#" id="yes2"><button class="btn btn-sm btn-danger">Có</button></a></div>
       </div>
